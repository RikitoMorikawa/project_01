...
- [ ] 7. AWS インフラストラクチャの実装（環境別）
- [ ] 7.1 開発環境のインフラストラクチャを作成
...
- [ ] 9. CI/CD パイプラインの実装（環境別デプロイ）
- [ ] 9.1 開発環境用 CI/CD パイプラインを作成
...
- [ ] 9.2 ステージング・本番環境用 CI/CD パイプラインを作成
