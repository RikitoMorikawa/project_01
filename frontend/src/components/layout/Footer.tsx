...
const Footer: React.FC<FooterProps> = ({ companyName = "CSR Lambda API", showLinks = true }) => {
    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="container py-8 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 text-sm mb-4">
              最新のクラウド技術を活用したサーバーレスアプリケーションプラットフォーム。 柔軟で拡張性の高いソリューションを提供します。
            </p>
            ...
            <>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="/api-docs" className="text-sm text-gray-600 hover:text-gray-900 transition">
                      API ドキュメント
                    </Link>
                  </li>
                  <li>
                    <Link href="/integrations" className="text-sm text-gray-600 hover:text-gray-900 transition">
                      連携サービス
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="/status" className="text-sm text-gray-600 hover:text-gray-900 transition">
                      システム状況
                    </Link>
                  </li>
                  <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center">
          ...
          <p className="text-xs text-gray-500">Built with Next.js, FastAPI, and AWS Lambda</p>
        </div>
      </div>
    </footer>
  );
